        ...
        <header class="w-full p-6">
            <nav class="mx-auto grid grid-cols-3 max-w-5xl">
                ...
                <div class="flex flex-row justify-center items-center gap-x-6 max-sm:[&>*:not(:nth-child(2))]:hidden">
                    ...
                    <form id="searchForm" action="/api/articles" novalidate class="group relative flex flex-row -mr-4 gap-x-2 items-center rounded-full py-1 hover:ring-opacity-100 focus-within:ring-opacity-100 has-[input:not(:placeholder-shown)]:ring-opacity-100 hover:px-4 focus-within:px-4 has-[input:not(:placeholder-shown)]:px-4 hover:mr-0 focus-within:mr-0 has-[input:not(:placeholder-shown)]:mr-0 ring-1 ring-slate-800 ring-opacity-0 transition-[padding,margin,box-shadow] duration-500">
                        <!-- Search Icon -->
                        <button type="submit">
